  ...
  return (
    <div className="min-h-[calc(100vh-5rem)] bg-[#F4F7FB] p-6 md:p-12">
      <div className="max-w-7xl mx-auto">
        ...
        {/* HEADER BAR */}
        <div className="bg-white rounded-2xl sm:rounded-[2rem] border border-slate-200 p-5 sm:p-8 shadow-sm mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">Staff Operations Hub</h1>
            <div className="flex flex-wrap items-center gap-3 mt-1.5">
              <span className="text-xs sm:text-sm font-semibold text-slate-400 uppercase tracking-wider">Active Workspace:</span>
              <span className="text-xs sm:text-sm font-black text-blue-600 uppercase">{confName}</span>
          ...
          <div className="flex flex-col items-start md:items-end w-full md:w-auto">
            ...
            {/* DISPLAY METRIC */}
            <div className="mt-3 text-left md:text-right bg-slate-50 px-4 py-2 rounded-xl border border-slate-200/60 shadow-inner w-full md:w-auto">
              <p className="text-[10px] text-slate-400 font-black uppercase tracking-wider"> Live Database Size: <span className="ml-1 text-sm font-bold text-slate-800">{count}</span></p>
            </div>
          </div>
        </div>
