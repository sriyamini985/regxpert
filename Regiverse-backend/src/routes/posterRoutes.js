...
router.get("/admin/list/:conferenceId", requireAuth, adminGetPosters);
router.post(
  "/admin/create",
  requireAuth,
  upload.fields([
...
router.delete("/admin/delete/:id", requireAuth, adminDeletePoster);
router.post("/admin/bulk-upload", requireAuth, adminBulkUploadPosters);
